...
if __name__ == "__main__":
    # On Colab set GRADIO_SHARE=1 to get a public *.gradio.live link.
    # Locally (Mac) leave it unset to just open a localhost tab.
    share = os.environ.get("GRADIO_SHARE", "0") == "1"
    demo.queue(
        max_size=50,
        default_concurrency_limit=1,
    ).launch(share=share, inbrowser=not share, show_error=True)
